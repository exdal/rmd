/*
	...
	This file was auto-generated by Dream Maker only to show the code that is
	automatically compiled at the beginning of every project. Including this
    file in your compilation will not work, and altering its contents will
    have no effect.
