...
#define MOUSE_LINK 64
#define MOUSE_X1_BUTTON 128
#define MOUSE_X2_BUTTON 256
...
sound
	var
		...
		pitch
		params
		len = 0	// only used by client.SoundQuery() for now
		atom
		transform	// 4x4 projection matrix, same format as particles
...
particles
	// vars that apply to the entire set
